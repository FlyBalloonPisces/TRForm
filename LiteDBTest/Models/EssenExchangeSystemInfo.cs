...
{
    public class EssenExchangeSystemInfo : ITextProcessing
    {
        ...
        public EssenExchangeSystemInfo()
        {
            fdExchangeID = 0;
            fdSystemNum = 0;
            fdMix = false;
        ...
        public EssenExchangeSystemInfo(uint fdExchangeID, ushort fdSystemNum, bool fdMix, ushort fdExchangeType, uint fdExchangeItem, ushort fdExchangeCount, ushort fdExchangeRate)
        {
