...
namespace TalesRunnerForm
{
    public static class StaticVars
    {
        ...
        internal static readonly byte[] xorKey2_kr =
        {
            0x1c, 0x67, 0x5b, 0xd4, 0x5b, 0x4a, 0x46, 0x74, 0x31, 0x7,
            0x4b, 0x82, 0xab, 0x3f, 0x55, 0xfd
        };
        internal static readonly byte[] aesKey1_hk =
        {
            0x0D, 0x68, 0x07, 0x6F, 0x0A, 0x09, 0x07, 0x6C, 0x65, 0x73,
            0x0D, 0x75, 0x6E, 0x0A, 0x65, 0x0D
        };
        internal static readonly byte[] xorKey1_hk =
        {
            0x05, 0x5B, 0xCB, 0x64, 0xFB, 0xC2, 0xCE, 0xB4, 0x77, 0x8B,
            0x1B, 0xB8, 0xE9, 0xB5, 0x9C, 0xC6
        };
        internal static readonly byte[] aesKey2_hk =
        {
        ...
        internal static readonly byte[] xorKey2_hk =
        {
        ...
        // 数组控制用常量
        // TODO 人物数的自动读取
        internal const int Characters_kr = 28; // 28个常规角色
        internal const int Characters_hk = 27; // 27个常规角色
        ...
        internal static readonly string[] tr_pkg_hk =
        {
            "9"
        };
