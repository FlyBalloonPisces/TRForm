...
{
    public class TblAvatarItemSetDesc
    {
        ...
        public static string fileName { get; } = "tblavataritemsetdesc";

        /// <summary>
        /// 空白构造函数
        /// </summary>
        public TblAvatarItemSetDesc() 
        {
            groupIdx = 0;
            memberIdx = 0;
            active = 0;
        ...
        public TblAvatarItemSetDesc(uint groupIdx, uint memberIdx, int active, ushort compCount)
        {
