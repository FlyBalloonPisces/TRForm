...
namespace TRTextProcessingClassLibrary
{
    public class TRLuckyBag : TRSupplyItem
    {
        ...
        public TRLuckyBag(uint itemNum, string name, string nameCh, byte level, ushort pkgNum, long picOffset, uint position, uint itemKind, bool showDetailImage, string desc, List<float> weightBasic, List<int> memberBasic, bool openable) : base(itemNum, name, nameCh, level, pkgNum, picOffset, position, itemKind, showDetailImage, desc)
        {
