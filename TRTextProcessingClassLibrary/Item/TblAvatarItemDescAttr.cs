...
{
    public class TblAvatarItemDescAttr
    {
        ...
        public static string fileName { get; } = "tblavataritemdescattr";

        /// <summary>
        /// 空白构造函数
        /// </summary>
        public TblAvatarItemDescAttr()
        {
            fdNum = 0;
            fdItemNum = 0;
            fdAttr = 0;
        ...
        public TblAvatarItemDescAttr(uint fdNum, uint fdItemNum, ushort fdAttr, float fdValue)
        {
            this.fdNum = fdNum;
        ...
        public TblAvatarItemDescAttr(string text)
        {
            // 分割文本
