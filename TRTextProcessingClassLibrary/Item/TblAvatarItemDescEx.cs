...
{
    public class TblAvatarItemDescEx
    {
        ...
        public static string fileName { get; } = "tblavataritemdescex";

        /// <summary>
        /// 空白构造函数
        /// </summary>
        public TblAvatarItemDescEx() 
        {
            fdNum = 0;
        ...
        public TblAvatarItemDescEx(uint fdNum, uint fdVirtualItemDescNum, uint fdSupplyItemDescNum, bool fdHasExpireTime, uint fdExpireMinute, ushort fdCount)
        {
            this.fdNum = fdNum;
