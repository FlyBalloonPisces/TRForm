...
{
    public class TblAvatarItemDesc
    {
        ...
        public static string fileName { get; } = "tblavataritemdesc";

        /// <summary>
        /// 空白构造函数
        /// </summary>
        public TblAvatarItemDesc() 
        {
            fdItemNum = 0;
            fdItemCategory = 0;
            fdType = 0;
        ...
        public TblAvatarItemDesc(uint fdItemNum, ushort fdBillingItemID, ushort fdType, ushort fdCharacter, uint fdPosition, uint fdItemKind, uint fdGameMoney, uint fdFarmPoint, uint fdCash, uint fdGuildPoint, uint fdContributionPoint, string fdItemName, uint fdItemCategory, ushort fdGotRateKind, ushort fdOnOfftype, bool fdCanUse, bool fdNotDeleteWhenExpired, bool fdCanStack, bool fdNewMark, ushort fdCoupleItemType, bool fdShowShop, bool fdPurchasable, bool fdShowDetailImage, string fdDesc, bool fdRefundable, uint fdEtc, ushort fdLevel, string fdFixedExpireDate)
        {
