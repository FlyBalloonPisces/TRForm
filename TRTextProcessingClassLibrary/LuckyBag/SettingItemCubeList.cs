...
{
    public class SettingItemCubeList
    {
        ...
        public static string fileName { get; } = "settingitemcubelist";

        public SettingItemCubeList()
        {
            this.fdCubeItem = 0;
