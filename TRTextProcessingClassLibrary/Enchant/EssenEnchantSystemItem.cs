...
{
    public class EssenEnchantSystemItem
    {
        ...
        public static string fileName { get; } = "essenenchantsystemitem";

        public EssenEnchantSystemItem()
        {
            fdItemNum = 0;
            fdSeqNum = 0;
            fdSocketNum = 0;
        ...
        public EssenEnchantSystemItem(uint fdItemNum, ushort fdSeqNum, ushort fdSocketNum, ushort fdCostType, ushort fdCost)
        {
