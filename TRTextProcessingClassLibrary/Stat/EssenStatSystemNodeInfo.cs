...
{
    public class EssenStatSystemNodeInfo
    {
        ...
        public static string fileName { get; } = "essenstatsystemnodeinfo";


        public EssenStatSystemNodeInfo()
        {
            fdCatType = 0;
            fdAttrType = 0;
            fdAttrLevel = 0;
        ...
        public EssenStatSystemNodeInfo(uint fdCatType, bool fdIsMain, ushort fdAttrType, ushort fdAttrLevel, float fdAttrValue, ushort fdNeedSP, string fdTitle, uint fdOrder)
        {
